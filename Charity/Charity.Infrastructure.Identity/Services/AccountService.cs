...
using Charity.Infrastructure.Identity.Helpers;
using Charity.Infrastructure.Identity.Models;
...
using Charity.Application.IdentityModule.Enums;
...
namespace Charity.Infrastructure.Identity.Services
{
    public class AccountService : IAccountService
    {
        ...
        public async Task<Response<AuthenticationResponse>> AuthenticateAsync(AuthenticationRequest request, string ipAddress)
        {
            ...
            if (!result.Succeeded)
            {
                throw new ApiException($"نام کاربری یا رمز عبور درست نیست");
            }
