...
{
    public class PhilanthropistUploadRequestValidator : AbstractValidator<UploadPhilanthropistImageRequest>
    {
        public PhilanthropistUploadRequestValidator(IOptions<UploadSettings> options)
        {
