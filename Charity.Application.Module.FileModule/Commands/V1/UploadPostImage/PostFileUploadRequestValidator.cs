...
{
    public class PostFileUploadRequestValidator : AbstractValidator<PostFileUploadRequest>
    {
        public PostFileUploadRequestValidator(IOptions<UploadSettings> options)
        {
